...
def get_list(first_name: str = Query(None, alias="firstName"),
    ...
    return user_service.find_paginated({"filters": [], "table_filters": table_filters, "pag_params": pag_params, "db": db, "sort": sort})
